...
new_payload = {
    "prompt": "claudia black {man|woman} ((red hair)) full body photo walking towards the camera, green dress on a runway, highly detailed, intricate, ultra hd, sharp photo, professional studio lighting, in focus, (Best Quality, Masterpiece:1.4), (Realism:1.2), (Realistic:1.2), (Absurdres:1.2), (photorealistic:1.3), Realistic Skin,(beautiful detailed eyes, symmetric eyes,), slim curvy body, look at the viewer, (big breasts), gorgeous female, <lora:CBlack:0.65>",
    "negative_prompt": "(worst quality:1.2), (bad quality:1.2), (poor quality:1.2), bad-artist-anime, bad-artist, bad-picture-chill-75v, badhandv4, bad_prompt_version2, ng_deepnegative_v1_75t, 3d, sketches, (worst quality:2), (low quality:2), (normal quality:2), low res, ((monochrome)), ((grayscale)), text, error, cropped,  jpeg artifacts, signature, watermark, username, blurry, cropped, deformed, double, duplicate, ((out of frame)), bad art, disfigured, cartoon, ugly, unrealistic, (poorly drawn), boring, sketch, lackluster, horrific, b&w, crooked, broken, weird, odd, distorted, drawing, painting, crayon, sketch, graphite, impressionist, noisy, soft, grainy",
    "styles": ["string"],
    "seed": -1,
    "subseed": -1,
    "subseed_strength": 0,
