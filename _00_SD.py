...
new_payload = {
    "prompt": "A wise-looking {dog|cat} playing an electric guitar on an ancient mystical looking stage, highly detailed, intricate, ultra hd, sharp photo, professional studio lighting, in focus, (Best Quality, Masterpiece:1.4), (Realism:1.2), (Realistic:1.2), (Absurdres:1.2), (photorealistic:1.3), Realistic Skin,(beautiful detailed eyes, symmetric eyes,), look at the viewer",
    "negative_prompt": "(worst quality:1.2), (bad quality:1.2), (poor quality:1.2), badhandv4, 3d, sketches, (worst quality:2), (low quality:2), (normal quality:2), low res, ((monochrome)), ((grayscale)), text, error, cropped,  jpeg artifacts, signature, watermark, username, blurry, cropped, deformed, double, duplicate, ((out of frame)), bad art, disfigured, cartoon, ugly, unrealistic, (poorly drawn), boring, sketch, lackluster, horrific, b&w, crooked, broken, weird, odd, distorted, drawing, painting, crayon, sketch, graphite, impressionist, noisy, soft, grainy",
    "styles": ["string"],
    "seed": -1,
    "subseed": -1,
    "subseed_strength": 0,
